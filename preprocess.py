'''
used to read csvs in miniimagenet
and split train val test datasets
'''
import csv
import os
from PIL import Image
train_csv_path=r".\miniimagenet\train.csv"
val_csv_path=r".\miniimagenet\val.csv"
test_csv_path=r".\miniimagenet\test.csv"
...
img_path=r".\miniimagenet\images"
new_img_path=r".\new_miniimagenet"
